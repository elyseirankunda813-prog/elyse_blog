    ...
    <section id="about" className="about" aria-label="About me">
      <div className="about-inner">
        <div className="about-text">
          ...
          <div className="about-stats" role="list" aria-label="Statistics">
            <div role="listitem">
        ...
        <div className="about-visual" role="list" aria-label="Details">
          <div className="about-card" role="listitem">
